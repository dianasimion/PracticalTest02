...
public class ServerThread extends Thread {
    ...
    private final HashMap<String, TimerInformation> data;
    ...
    public synchronized void setData(String ip, TimerInformation timerInfo) {
        this.data.put(ip, timerInfo);
    }

    public synchronized void removeData(String ip) {
        this.data.remove(ip);
    }
